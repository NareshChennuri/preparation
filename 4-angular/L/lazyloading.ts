...
for small size applications we can use eager loading.

Lazy loading is dynamically loads the feature modules when there's a demand. This makes the application faster. 
