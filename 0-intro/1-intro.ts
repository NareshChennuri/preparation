...
I work closely with UX teams, often taking designs straight from Figma and turning them into clean, 
responsive UI using Angular, SCSS, and component libraries. I'm a big believer in writing modular,
 maintainable code that follows best practices—not just to ship features faster, but to keep things solid in the long run.

I lead a cross-functional UI team, coordinating with designers, backend teams, QA, and product folks. 
I also work with offshore teams, making sure everything stays aligned and on track. 
Agile is part of my day-to-day—whether it's sprint planning, standups, or retros—I’m involved at every step.
